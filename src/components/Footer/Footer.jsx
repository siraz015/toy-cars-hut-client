        ...
        <div className='bg-base-300 mt-10'>
            <footer className="footer p-10 text-base-content max-w-[1280px] mx-auto">
                <div>
                    ...
                    <h2 className='font-bold text-3xl text-blue-600'>Toy Cars Hut</h2>
                </div>
                <div>
                ...
                <div>
                    ...
                    <a className="link link-hover font-semibold">Uttra, 3 no Sector, <br /> Banani, Dhaka</a>
                    <a className="link link-hover">Phone: +880 111 222 333</a>
                    <a className="link link-hover">E-mail: sample@gmail.com</a>
                </div>
                <div>
            ...
            <div className='text-center pb-5 font-semibold'><p>Copyright © 2023 - All right reserved</p></div>
        </div>
    );
};
